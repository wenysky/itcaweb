...
override protected void OnInit(EventArgs e)
{
	...
	Response.Write("		<!--文章开始-->\r\n");
	Response.Write("		<div class=\"div-header\"><a href=\"#\">返回列表</a> | 上一篇文章:<a href=\"#\">GMail再次更新:带来新主题</a> | 下一篇文章:<a href=\"#\">Google处理1TB数据只需68秒 1PB六个小时</a></div>\r\n");
	Response.Write("		<h2 class=\"title article\">" + articleinfo.Title.ToString().Trim() + "</h2>\r\n");
